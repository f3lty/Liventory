...
const DEMO_INVENTORY = [
  ...
  { plantName: "Spirea Goldflame", botanicalName: "Spiraea japonica", cultivar: "Goldflame", containerSize: "2 Gal", quantityAvailable: 78, quantityReserved: 8, quantitySold: 89, location: "Hoop House B", propagationMethod: PropagationMethod.CUTTING, costPerUnit: 5.50, retailPrice: 22.99, wholesalePrice: 11.00, category: "Deciduous Shrubs", lowStockThreshold: 25 },
...
export async function seedDemoData() {
  ...
  // Create inventory
  const createdInventory: { id: string }[] = [];
  for (const item of DEMO_INVENTORY) {
    ...
    createdInventory.push({ id: created.id });
  }
